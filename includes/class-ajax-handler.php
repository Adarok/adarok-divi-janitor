...
/**
 * Adarok Divi Janitor AJAX Handler Class
 *
 * Handles AJAX requests for deleting library items.
 *
 * @since 1.0.0
 */
class Adarok_Divi_Janitor_Ajax_Handler {
	...
	public function bulk_delete_safe() {
		...
		// Suppress PHP warnings from Divi's dynamic assets.
		$old_error_level = error_reporting( E_ERROR | E_PARSE ); // phpcs:ignore WordPress.PHP.DevelopmentFunctions.prevent_path_disclosure_error_reporting, WordPress.PHP.DiscouragedPHPFunctions.runtime_configuration_error_reporting -- Intentionally suppress warnings during bulk operations.
		...
		error_reporting( $old_error_level ); // phpcs:ignore WordPress.PHP.DevelopmentFunctions.prevent_path_disclosure_error_reporting, WordPress.PHP.DiscouragedPHPFunctions.runtime_configuration_error_reporting -- Restore error reporting level.
